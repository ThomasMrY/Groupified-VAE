...
from data.ground_truth import norb
from data.ground_truth import shapes3d
from data.ground_truth import overlap144
from data.ground_truth import overlap1920
import gin.tf
...
def get_named_ground_truth_data(name):
  ...
  elif name == "overlap144":
    return overlap144.Overlap()
  elif name == "overlap1920":
    return overlap1920.Overlap()
